  ...
  return (
    <GlobalProvider>
      <div id="app-wrapper" style={{ display: 'flex', minHeight: '100vh', backgroundColor: 'var(--bg-primary)' }}>
        ...
        <JiraImportModal isOpen={isJiraImportModalOpen} onClose={handleCloseJiraImportModal} onImportSuccess={handleJiraImportSuccess} projects={projects} allReleases={allReleases} currentProject={selectedProject} importType="requirements" showMessage={showMainMessage} />
